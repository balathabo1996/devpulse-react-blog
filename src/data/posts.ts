...
export const posts: Post[] = [
  ...
  },
  {
    ...
    content: 'The tech landscape changes fast. To stay relevant, focus on fundamental problem-solving skills rather than just syntax. building a "T-shaped" skill set—deep knowledge in one area and broad knowledge in others—is more valuable than ever. Networking and soft skills are just as critical as technical prowess.',
    category: 'Career',
  ...
  },
  {
    ...
    content: 'Understanding React Hooks is essential for modern React development. The `useEffect` hook handles side effects, but it can be tricky. Always define your dependencies correctly to avoid stale closures. Custom hooks allow you to extract logic and make your components cleaner and more reusable.',
    category: 'Tutorials',
